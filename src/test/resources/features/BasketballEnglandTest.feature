  ...
  Scenario Outline: Create an account
    ...
    * the user accepts the Code of Ethics and Conduct
    ...
    Examples:
      ...
      | Chrome  | 02/12/2000  | Nils      |            | test2@test.com | test123  | test123              | Coach, Sports science role         | Partners                 | Failure         | Last Name is required  |
      | Chrome  | 29/02/2000  | Erik       | Henriksson | test3@test.com | test123  | test234              | Player, Player's relative/guardian | Marketing & Partners     | Failure         | Password did not match |
